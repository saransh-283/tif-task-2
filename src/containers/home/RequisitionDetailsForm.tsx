    ...
    <Box width="100%" as="form" onSubmit={handleSubmit as any}>
      <Box width="100%">
        <FormInput
          ...
          onChange={e => {
            let temp = { ...state }
            temp.requisitionDetails.requisitionTitle = e.target.value
            setState(temp)
            handleChange(e)
          }}
          onBlur={handleBlur}
        ...
        <FormInput
          ...
          onChange={e => {
            let temp = { ...state }
            temp.requisitionDetails.noOfOpenings = parseInt(e.target.value)||0
            setState(temp)
            handleChange(e)
          }}
          onBlur={handleBlur}
        ...
        <FormSelect
          ...
          onChange={(field: string, value: any, shouldValidate?: boolean | undefined) => {
            let temp = { ...state }
            temp.requisitionDetails.gender = value
            setState(temp)
        ...
        <FormSelect
          ...
          onChange={(field: string, value: any, shouldValidate?: boolean | undefined) => {
            let temp = { ...state }
            temp.requisitionDetails.urgency = value
            setState(temp)
            setFieldValue(field,value,shouldValidate)
          }}
          onBlur={setFieldTouched}
